...
const Resume5 = () => {
	...
	return (
		<section id="resume">
			<div className=" py-60px md:py-20 lg:py-30 relative after:absolute after:top-0 after:left-1/2  after:-translate-x-1/2 after:-translate-y-1/2 after:right-5 after:w-650px after:h-550px after:blur-[150px] after:rounded-50% after:bg-gradient-circle-2 after:-z-1   after:opacity-60">
				<div className="container">
					{/* <!-- section heading --> */}
					<div className="mb-10 md:mb-50px xl:mb-60px text-center flex flex-col items-center ">
						<div className="mb-25px  ">
							<span
								className="text-xs  uppercase text-primary-color  font-medium relative inline-block  wow fadeInUp"
								data-wow-delay=".3s"
							>
								Behind the Pixels
							</span>
						...
						<h2
							...
							data-wow-delay=".4s"
						>
							My Experience, Education & Awards
						</h2>
					</div>
					{/* <!-- resume tab --> */}
					<div className="">
