		...
		<div className="pb-20 md:pb-100px xl:pb-30">
		  <div className="container">
			...
			<div
			  ...
			  data-wow-delay=".3s"
			>
			  <span className="text-xs uppercase py-10px px-5 bg-primary-color dark:bg-seondary-color rounded-full text-white-color font-semibold inline-block relative">
				About
			  </span>
			</div>
			...
			<div>
			  <p
				...
				data-wow-delay=".4s"
			  >
				I’m a passionate Software Engineer based in the United States.{" "}
				I specialize in{" "}
				<span className="bg-gradient-primary-5 bg-clip-text text-transparent">
				  backend development, AI integration, and Data Science
				</span>{" "}
				— creating solutions that bridge real-world challenges and cutting-edge technology.
			  </p>
