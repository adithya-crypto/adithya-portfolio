	...
	return (
		<>
			{Odometer ? (
				<div
					ref={ref}
					className="flex-shrink-0 sm:rotate-[-90deg] w-full max-w-260px  border border-x-0 border-body-color dark:border-bg-color-2 sm:mb-70px xl:mb-65px 2xl:mb-45px"
				>
