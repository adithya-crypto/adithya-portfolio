			...
			{Odometer ? (
				<div className="funfact-area mt-35px">
					<div className="container">
						<div
							ref={ref}
							className="flex flex-wrap items-center justify-between px-5 py-30px xl:px-75px xl:py-35px bg-cream-light-color dark:bg-primary-color-light border border-body-color dark:border-seondary-color rounded-15px gap-x-15px gap-y-30px md:gap-25px text-primary-color dark:text-body-color"
						>
