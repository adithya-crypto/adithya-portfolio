...
const PortfolioCard7 = ({ portfolio }) => {
	...
	return (
		<div className="portfolio-item branding  px-15px pt-30px xl:p-35px border-2 border-body-color dark:border-bg-color-2 rounded-15px group relative">
			<Link
